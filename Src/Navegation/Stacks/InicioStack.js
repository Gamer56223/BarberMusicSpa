...
import AgendamientosStack from './AgendamientoStack'; // Importa AgendamientosStack desde su archivo
...
import ProductoPromocionesStack from "./ProductoPromocionStack";
import ProductosStack from "./ProductoStack";
import PromocionServiciosStack from "./PromocionServicioStack";
import PromocionesStack from "./PromocionStack";
import RecordatoriosStack from "./RecordatorioStack";
import ReseñasStack from "./ReseñaStack";
import ServicioPersonalesStack from "./ServicioPersonalStack";
...
export default function InicioStack () {
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen
                name="ProductoPromocionesFlow" 
                component={ProductoPromocionesStack}
                options={{ headerShown: false }}
            />
            ...
            <Stack.Screen
                name="PromocionServiciosFlow" 
                component={PromocionServiciosStack}
                options={{ headerShown: false }}
            />
            ...
            <Stack.Screen
                name="ReseñasFlow" 
                component={ReseñasStack}
                options={{ headerShown: false }}
            />

            <Stack.Screen
                name="ServicioPersonalesFlow" 
                component={ServicioPersonalesStack}
                options={{ headerShown: false }}
            />
